# Generated by Django 3.0.5 on 2020-04-05 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('allowed_choices', models.ManyToManyField(to='coffee.ToppingChoice')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='coffee.ToppingCategory')),
                ('default_choice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='default_toppings', to='coffee.ToppingChoice')),
            ],
        ),
        migrations.CreateModel(
            name='ProductTopping',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=0, max_digits=4)),
                ('is_active', models.BooleanField(default=True)),
                ('allowed_foams', models.ManyToManyField(to='coffee.FoamChoice')),
                ('allowed_temps', models.ManyToManyField(to='coffee.TempChoice')),
                ('default_foam', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='default_product_milks', to='coffee.FoamChoice')),
                ('default_temp', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='default_product_milks', to='coffee.TempChoice')),
        ...
        migrations.AddField(
            model_name='product',
            name='allowed_ice',
            field=models.ManyToManyField(to='coffee.IceChoice'),
        ),
        migrations.AddField(
            model_name='product',
            name='allowed_juices',
        ...
        migrations.AddField(
            model_name='product',
            name='allowed_room',
            field=models.ManyToManyField(to='coffee.RoomChoice'),
        ),
        migrations.AddField(
            model_name='product',
            name='allowed_sizes',
        ...
        migrations.AddField(
            model_name='product',
            name='default_ice',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='default_products', to='coffee.IceChoice'),
        ),
        migrations.AddField(
            model_name='product',
            name='default_juices',
        ...
        migrations.AddField(
            model_name='product',
            name='default_room',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='default_products', to='coffee.RoomChoice'),
        ),
        migrations.AddField(
            model_name='product',
            name='default_size',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ice', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='coffee.IceChoice')),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='coffee.Product')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='coffee.RoomChoice')),
