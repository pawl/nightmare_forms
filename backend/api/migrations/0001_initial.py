    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espresso_shots', models.ManyToManyField(to='api.OrderItemProductEspressoShot')),
                ('flavors', models.ManyToManyField(to='api.OrderItemProductFlavor')),
                ('ice', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.IceChoice')),
                ('juices', models.ManyToManyField(to='api.OrderItemProductJuice')),
                ('milk', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.ProductMilk')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.Product')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.RoomChoice')),
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.ProductSize')),
                ('sweeteners', models.ManyToManyField(to='api.OrderItemProductSweetener')),
                ('teas', models.ManyToManyField(to='api.OrderItemProductTea')),
                ('toppings', models.ManyToManyField(to='api.OrderItemProductTopping')),
            ],
        ),
        migrations.AddField(
            model_name='flavor',
